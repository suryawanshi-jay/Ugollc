...
//    cardList.add(new DropdownMenuItem(child: new Divider(height: 0.0,)));
  ...
  Widget _totalRow(String text, String type, {double addedAmount: 0.0}) {
    ...
    if(type == 'Sales Tax' && totals.length == 0) {
      return new Container();
    }
                  ...
                  child: new Column(
                    children: <Widget>[
                      ...
                      showSpeedDelivery ? new Container(
                        padding:  new EdgeInsets.fromLTRB(12.0, 0.0, 8.0, 12.0),
                        child: new Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: <Widget>[
                            new Text("Additional delivery charges may apply*", style: new TextStyle(fontSize: 11.0)),
                          ],
                        ),
                      ): new Container(),
                      new Container(
